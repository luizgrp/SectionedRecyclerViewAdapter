 ...
 * 3 - visible section, headed and footed with only 1 item
 * 4 - invisible section, headed and footed with 10 items
 *
 * Section number 3 is the section under test.
 */
public class Scenario2 implements TestScenario {

    private static final String SECTION_TAG = "scenario2SectionTag";
    ...
    public Scenario2() {
        ...
        when(section.getContentItemsTotal()).thenReturn(1);
        when(section.getSectionItemsTotal()).thenReturn(3);
