 ...
 * 3 - visible section, headed and footed with 10 items
 * 4 - invisible section, headed and footed with 10 items
 *
 * Section number 3 is the section under test.
 */
public class Scenario1 implements TestScenario {

    private static final String SECTION_TAG = "scenario1SectionTag";
    ...
    public Scenario1() {
        ...
        when(section.getContentItemsTotal()).thenReturn(10);
